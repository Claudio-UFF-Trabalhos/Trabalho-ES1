	          ...
	          <div class="col-lg-6">
	            ...
	            <form class="form" method="post" action="editaRevista" role="form">
	              ...
	              <div class="form-group">
	                ...
	                <input name="nome" value="${revista.nome}" autocomplete="off" class="form-control nome" maxlength="100">
	              </div>
	              
	              <div class="form-group">
	                <label class="non-radio-label">Tipo: <span class="required-field">* </span></label>
	                <input name="tipo" value="${revista.tipo}" autocomplete="off" class="form-control tipo" maxlength="100">
	              </div>
	              
	              <div class="form-group">
	                <label class="non-radio-label">Descrição da revista: </label>
	                <input name="descricao" value="${revista.descricao}" autocomplete="off" class="form-control descricao" maxlength="100">
	              </div>
	              ...
	              <div class="form-group">
	                ...
	                <input name="precoDe" value="${revista.precoDe}" autocomplete="off" class="form-control precoDe" maxlength="10">
	              </div>
				...
				<br />
				<br />
				<a class="back_button" href="http://localhost:8080/ES1Project/revista/listaRevista">voltar para lista de revistas</a>
	          </div>
	        </div><!-- /.row -->
		</div>
      </div><!-- /#page-wrapper -->
